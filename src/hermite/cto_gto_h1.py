...
def cto_gto_h1(Mxyz,TP_A):
    ...
    for irow in range(Np):
        ...
        for iket in TP_A:
            ...
            if iket == 'i':
                # ml: -6
                Mtemp[irow,icol] = I12_1*Mxyz[irow,jcol+1]+I12_6*Mxyz[irow,jcol+6]+I12_15*Mxyz[irow,jcol+15]
                # ml: -5
                Mtemp[irow,icol+1] = I10_4*Mxyz[irow,jcol+4]+I10_11*Mxyz[irow,jcol+11]+I10_22*Mxyz[irow,jcol+22]
                # ml: -4
                Mtemp[irow,icol+2] = I8_1*Mxyz[irow,jcol+1]+I8_8*Mxyz[irow,jcol+8]+I8_15*Mxyz[irow,jcol+15]
                Mtemp[irow,icol+2]+= I8_17*Mxyz[irow,jcol+17]
                # ml: -3
                Mtemp[irow,icol+3] = I6_4*Mxyz[irow,jcol+4]+I6_11*Mxyz[irow,jcol+11]+I6_13*Mxyz[irow,jcol+13]
                Mtemp[irow,icol+3]+= I6_22*Mxyz[irow,jcol+22]+I6_24*Mxyz[irow,jcol+24]
                # ml: -2
                Mtemp[irow,icol+4] = I4_1*Mxyz[irow,jcol+1]+I4_6*Mxyz[irow,jcol+6]+I4_8*Mxyz[irow,jcol+8]
                Mtemp[irow,icol+4]+= I4_15*Mxyz[irow,jcol+15]+I4_17*Mxyz[irow,jcol+17]+I4_19*Mxyz[irow,jcol+19]
                # ml: -1
                Mtemp[irow,icol+5] = I2_4*Mxyz[irow,jcol+4]+I2_11*Mxyz[irow,jcol+11]+I2_13*Mxyz[irow,jcol+13]
                Mtemp[irow,icol+5]+= I2_22*Mxyz[irow,jcol+22]+I2_24*Mxyz[irow,jcol+24]+I2_26*Mxyz[irow,jcol+26]
                # ml: 0
                Mtemp[irow,icol+6] = I0_0*Mxyz[irow,jcol]+I0_3*Mxyz[irow,jcol+3]+I0_5*Mxyz[irow,jcol+5]
                Mtemp[irow,icol+6]+= I0_10*Mxyz[irow,jcol+10]+I0_12*Mxyz[irow,jcol+12]+I0_14*Mxyz[irow,jcol+14]
                Mtemp[irow,icol+6]+= I0_21*Mxyz[irow,jcol+21]+I0_23*Mxyz[irow,jcol+23]+I0_25*Mxyz[irow,jcol+25]
                Mtemp[irow,icol+6]+= I0_27*Mxyz[irow,jcol+27]
                # ml: 1
                Mtemp[irow,icol+7] = I1_2*Mxyz[irow,jcol+2]+I1_7*Mxyz[irow,jcol+7]+I1_9*Mxyz[irow,jcol+9]
                Mtemp[irow,icol+7]+= I1_16*Mxyz[irow,jcol+16]+I1_18*Mxyz[irow,jcol+18]+I1_20*Mxyz[irow,jcol+20]
                # ml: 2
                Mtemp[irow,icol+8] = I3_0*Mxyz[irow,jcol]+I3_3*Mxyz[irow,jcol+3]+I3_5*Mxyz[irow,jcol+5]
                Mtemp[irow,icol+8]+= I3_10*Mxyz[irow,jcol+10]+I3_14*Mxyz[irow,jcol+14]+I3_21*Mxyz[irow,jcol+21]
                Mtemp[irow,icol+8]+= I3_23*Mxyz[irow,jcol+23]+I3_25*Mxyz[irow,jcol+25]
                # ml: 3
                Mtemp[irow,icol+9] = I5_2*Mxyz[irow,jcol+2]+I5_7*Mxyz[irow,jcol+7]+I5_9*Mxyz[irow,jcol+9]
                Mtemp[irow,icol+9]+= I5_16*Mxyz[irow,jcol+16]+I5_18*Mxyz[irow,jcol+18]
                # ml: 4
                Mtemp[irow,icol+10] = I7_0*Mxyz[irow,jcol]+I7_3*Mxyz[irow,jcol+3]+I7_5*Mxyz[irow,jcol+5]
                Mtemp[irow,icol+10]+= I7_10*Mxyz[irow,jcol+10]+I7_12*Mxyz[irow,jcol+12]+I7_21*Mxyz[irow,jcol+21]
                Mtemp[irow,icol+10]+= I7_23*Mxyz[irow,jcol+23]
                # ml: 5
                Mtemp[irow,icol+11] = I9_2*Mxyz[irow,jcol+2]+I9_7*Mxyz[irow,jcol+7]+I9_16*Mxyz[irow,jcol+16]
                # ml: 6
                Mtemp[irow,icol+12] = I11_0*Mxyz[irow,jcol]+I11_3*Mxyz[irow,jcol+3]+I11_10*Mxyz[irow,jcol+10]
    ...
    for ibra in TP_A:
        ...
        if iket == 'i':
            for icol in range(Nsph):
                # ml: -6
                Mrtp[irow,icol] = I12_1*Mtemp[jrow+1,icol]+I12_6*Mtemp[jrow+6,icol]+I12_15*Mtemp[jrow+15,icol]
                # ml: -5
                Mrtp[irow+1,icol] = I10_4*Mtemp[jrow+4,icol]+I10_11*Mtemp[jrow+11,icol]+I10_22*Mtemp[jrow+22,icol]
                # ml: -4
                Mrtp[irow+2,icol] = I8_1*Mtemp[jrow+1,icol]+I8_8*Mtemp[jrow+8,icol]+I8_15*Mtemp[jrow+15,icol]
                Mrtp[irow+2,icol]+= I8_17*Mtemp[jrow+17,icol]
                # ml: -3
                Mrtp[irow+3,icol] = I6_4*Mtemp[jrow+4,icol]+I6_11*Mtemp[jrow+11,icol]+I6_13*Mtemp[jrow+13,icol]
                Mrtp[irow+3,icol]+= I6_22*Mtemp[jrow+22,icol]+I6_24*Mtemp[jrow+24,icol]
                # ml: -2
                Mrtp[irow+4,icol] = I4_1*Mtemp[jrow+1,icol]+I4_6*Mtemp[jrow+6,icol]+I4_8*Mtemp[jrow+8,icol]
                Mrtp[irow+4,icol]+= I4_15*Mtemp[jrow+15,icol]+I4_17*Mtemp[jrow+17,icol]+I4_19*Mtemp[jrow+19,icol]
                # ml: -1
                Mrtp[irow+5,icol] = I2_4*Mtemp[jrow+4,icol]+I2_11*Mtemp[jrow+11,icol]+I2_13*Mtemp[jrow+13,icol]
                Mrtp[irow+5,icol]+= I2_22*Mtemp[jrow+22,icol]+I2_24*Mtemp[jrow+24,icol]+I2_26*Mtemp[jrow+26,icol]
                # ml: 0
                Mrtp[irow+6,icol] = I0_0*Mtemp[jrow,icol]+I0_3*Mtemp[jrow+3,icol]+I0_5*Mtemp[jrow+5,icol]
                Mrtp[irow+6,icol]+= I0_10*Mtemp[jrow+10,icol]+I0_12*Mtemp[jrow+12,icol]+I0_14*Mtemp[jrow+14,icol]
                Mrtp[irow+6,icol]+= I0_21*Mtemp[jrow+21,icol]+I0_23*Mtemp[jrow+23,icol]+I0_25*Mtemp[jrow+25,icol]
                Mrtp[irow+6,icol]+= I0_27*Mtemp[jrow+27,icol]
                # ml: 1
                Mrtp[irow+7,icol] = I1_2*Mtemp[jrow+2,icol]+I1_7*Mtemp[jrow+7,icol]+I1_9*Mtemp[jrow+9,icol]
                Mrtp[irow+7,icol]+= I1_16*Mtemp[jrow+16,icol]+I1_18*Mtemp[jrow+18,icol]+I1_20*Mtemp[jrow+20,icol]
                # ml: 2
                Mrtp[irow+8,icol] = I3_0*Mtemp[jrow,icol]+I3_3*Mtemp[jrow+3,icol]+I3_5*Mtemp[jrow+5,icol]
                Mrtp[irow+8,icol]+= I3_10*Mtemp[jrow+10,icol]+I3_14*Mtemp[jrow+14,icol]+I3_21*Mtemp[jrow+21,icol]
                Mrtp[irow+8,icol]+= I3_23*Mtemp[jrow+23,icol]+I3_25*Mtemp[jrow+25,icol]
                # ml: 3
                Mrtp[irow+9,icol] = I5_2*Mtemp[jrow+2,icol]+I5_7*Mtemp[jrow+7,icol]+I5_9*Mtemp[jrow+9,icol]
                Mrtp[irow+9,icol]+= I5_16*Mtemp[jrow+16,icol]+I5_18*Mtemp[jrow+18,icol]
                # ml: 4
                Mrtp[irow+10,icol] = I7_0*Mtemp[jrow,icol]+I7_3*Mtemp[jrow+3,icol]+I7_5*Mtemp[jrow+5,icol]
                Mrtp[irow+10,icol]+= I7_10*Mtemp[jrow+10,icol]+I7_12*Mtemp[jrow+12,icol]+I7_21*Mtemp[jrow+21,icol]
                Mrtp[irow+10,icol]+= I7_23*Mtemp[jrow+23,icol]
                # ml: 5
                Mrtp[irow+11,icol] = I9_2*Mtemp[jrow+2,icol]+I9_7*Mtemp[jrow+7,icol]+I9_16*Mtemp[jrow+16,icol]
                # ml: 6
                Mrtp[irow+12,icol] = I11_0*Mtemp[jrow,icol]+I11_3*Mtemp[jrow+3,icol]+I11_10*Mtemp[jrow+10,icol]
