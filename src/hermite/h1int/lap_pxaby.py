...
def lap_pxaby(
    ...
    lineal momentum
            ...
            d/dB_y  ((Lap (nabla x A_B) + 3 (nabla x A_B) Lap)
    ...
    lap_pxaby: list = [0 for i in range(int(total_nprim * total_nprim))]
    ...
    if output > 10:
        driver_time.add_name_delta_time(
            name=f"Curl between nabla and potential vector of magnetic field on By and {magnetic_component} ",
