...
def lap_pxabz(
    ...
    lineal momentum
            ...
            d/dB_z  ((Lap (nabla x A_B) + 3 (nabla x A_B) Lap)
    ...
    lap_pxabz: list = [0 for i in range(int(total_nprim * total_nprim))]
    ...
    for j in range(total_nprim):
        ...
        for i in range(total_nprim):
            ...
            if magnetic_component == 2:
                ...
                lapa: float = (2.0*exp[i]*(4*exp[j]*exp[j]*
                        hermite_coefficient(
                            mla[i] + 1,
                            mla[j] + 2,
                            0,
    ...
    if output > 10:
        driver_time.add_name_delta_time(
            name=f"Curl between nabla and potential vector of magnetic field on Bz and {magnetic_component} ",
