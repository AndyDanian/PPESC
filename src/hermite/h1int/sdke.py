...
def sdke(
    ...
    Return:
        sdke (array): array 2d with atomic integrals
    """
    ...
    sdke: list = [0 for i in range(int(total_nprim * (total_nprim + 1) / 2))]
    # sdke: list = [0 for i in range(int(total_nprim * (total_nprim)))]
...
"""
            SD 001 x
    Implementación   DALTON
1,5:  -43159.43    -43159.43
1,8:   21579.72     21579.72
1,10:  21579.72     21579.72
2,2:   -1334.14     -1334.14
2,11:    -45.62       -45.62
3,3:     667.07       667.07
3,21:   -108.21      -108.21
