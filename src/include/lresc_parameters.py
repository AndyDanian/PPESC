...
lresc_scale = {
        ...
        "paranr": M*ALPHA2/2.0,
        # paramagnetic
        "fclap": -0.5*M*ALPHA2*ALPHA2/3.0, "sddxx": -M*ALPHA2*ALPHA2/4.0/4.0, #one 1./4. is because old lresc didn't eliminate this constant in the calculate the dptovl in the dalton
        "sddyy": -M*ALPHA2*ALPHA2/4.0/4.0, "sddzz": -M*ALPHA2*ALPHA2/4.0/4.0,
        "sddxy": -M*ALPHA2*ALPHA2/4.0/4.0, "sddxz": -M*ALPHA2*ALPHA2/4.0/4.0,
        "sddyx": -M*ALPHA2*ALPHA2/4.0/4.0, "sddyz": -M*ALPHA2*ALPHA2/4.0/4.0,
        "sddzx": -M*ALPHA2*ALPHA2/4.0/4.0, "sddzy": -M*ALPHA2*ALPHA2/4.0/4.0,
        "fcbso": -M*ALPHA2*ALPHA2/4.0, "sdbsoxx": -M*ALPHA2*ALPHA2/4.0,
        "sdbsoyy": -M*ALPHA2*ALPHA2/4.0, "sdbsozz": -M*ALPHA2*ALPHA2/4.0,
        "sdbsoxy": -M*ALPHA2*ALPHA2/4.0, "sdbsoxz": -M*ALPHA2*ALPHA2/4.0,
        "sdbsoyx": -M*ALPHA2*ALPHA2/4.0, "sdbsoyz": -M*ALPHA2*ALPHA2/4.0,
        "sdbsozx": -M*ALPHA2*ALPHA2/4.0, "sdbsozy": -M*ALPHA2*ALPHA2/4.0,
        ...
        "lsdsoxy": -M*ALPHA2/4.0, "lsdsoxz": -M*ALPHA2/4.0,
        "lsdsoyx": -M*ALPHA2/4.0, "lsdsoyz": -M*ALPHA2/4.0,
        "lsdsozx": -M*ALPHA2/4.0, "lsdsozy": -M*ALPHA2/4.0,
...
lresc = {
        ...
        "sdkinyy": M*ALPHA2*ALPHA2/2.0, "sddzz": M*ALPHA2*ALPHA2/2.0,
        "sdkinxy": M*ALPHA2*ALPHA2/2.0, "sddxz": M*ALPHA2*ALPHA2/2.0,
        "sdkinyx": M*ALPHA2*ALPHA2/2.0, "sddyz": M*ALPHA2*ALPHA2/2.0,
        "sdkinzx": M*ALPHA2*ALPHA2/2.0, "sddzy": M*ALPHA2*ALPHA2/2.0,
        "fcbso": 2.0*M*ALPHA2*ALPHA2, "sdbsoxx": 2.0*M*ALPHA2*ALPHA2,
        "sdbsoyy": 2.0*M*ALPHA2*ALPHA2, "sdbsozz": 2.0*M*ALPHA2*ALPHA2,
        "sdbsoxy": 2.0*M*ALPHA2*ALPHA2, "sdbsoxz": 2.0*M*ALPHA2*ALPHA2,
        "sdbsoyx": 2.0*M*ALPHA2*ALPHA2, "sdbsoyz": 2.0*M*ALPHA2*ALPHA2,
        "sdbsozx": 2.0*M*ALPHA2*ALPHA2, "sdbsozy": 2.0*M*ALPHA2*ALPHA2,
        ...
        "lsdsoxy": M*ALPHA2/2.0, "lsdsoxz": M*ALPHA2/2.0,
        "lsdsoyx": M*ALPHA2/2.0, "lsdsoyz": M*ALPHA2/2.0,
        "lsdsoxz": M*ALPHA2/2.0, "lsdsozy": M*ALPHA2/2.0,
        "lpsomv": M*ALPHA2/2.0, "lpsodw": M*ALPHA2/2.0,
        # NR
        "dianr": M*ALPHA2,
        # diamagnetic
...
"paranr", "fclap", "sdlap", "fcbso", "sdbso",
"lpsokin", "lkinpso", "lfcso", "lsdso", "lpsomv",
"lpsodw", "a2dw", "a2mv"
]
#
...
triplet_lineal_responses = {"fclap": fclap,
                        ...
                        "fcbso": fcbso,
                        "sdbsoxx":sdbsoxx, "sdbsoyy": sdbsoyy, "sdbsozz": sdbsozz,
                        "sdbsoxy":sdbsoxy, "sdbsoxz": sdbsoxz, "sdbsoyx": sdbsoyx,
                        "sdbsoyz":sdbsoyz, "sdbsozx": sdbsozx, "sdbsozy": sdbsozy,
                        }
# - Singlet
# L-PsoKin
lpsokin = [
...
triplet_quadratic_responses = {"lfcso": lfcso,
                        "lsdsoxx": lsdsoxx, "lsdsoyy": lsdsoyy, "lsdsozz": lsdsozz,
