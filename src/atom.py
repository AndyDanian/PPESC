...
cartessian_mlx = {"s": [0], "p": [1, 0, 0], "d": [2,0,0,1,1,0], "f": [3,0,0,2,2,0,1,1,0,1],
                    "g": [4,0,0,3,3,1,0,1,0,2,2,0,2,1,1]}
cartessian_mly = {"s": [0], "p": [0, 1, 0], "d": [0,2,0,1,0,1], "f": [0,3,0,1,0,2,2,0,1,1],
                    "g": [0,4,0,1,0,3,3,0,1,2,0,2,1,2,1]}
cartessian_mlz = {"s": [0], "p": [0, 0, 1], "d": [0,0,2,0,1,1], "f": [0,0,3,0,1,1,0,2,2,1],
